var canvas, stage;
  ...
  var stroke = 5;
  var colors = [
              "#EFDECD","#CD9575","#FDD9B5","#78DBE2","#87A96B","#FFA474","#FAE7B5","#9F8170",
...
$(function() {
  ...
  function handleMouseDown(event) {
    ...
    socket.emit('draw', $.toJSON({action: 'start', user: clientName, start: oldMidPt, end:oldMidPt, color:penColor, stroke: stroke }));
  }
